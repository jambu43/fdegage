...
export default function SharePage() {
  ...
  const shareLinks = {
    ...
    twitter: `https://twitter.com/intent/tweet?url=${encodeURIComponent(petitionUrl)}&text=${encodeURIComponent(message)}`,
    whatsapp: `https://wa.me/?text=${encodeURIComponent(message + " " + petitionUrl)}`,
    telegram: `https://t.me/share/url?url=${encodeURIComponent(petitionUrl)}&text=${encodeURIComponent(message)}`,
